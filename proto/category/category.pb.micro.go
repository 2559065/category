...
type CategoryService interface {
	...
	FindCatehoryByLevel(ctx context.Context, in *FindByLevelRequest, opts ...client.CallOption) (*FindAllResponse, error)
...
func (c *categoryService) FindCatehoryByLevel(ctx context.Context, in *FindByLevelRequest, opts ...client.CallOption) (*FindAllResponse, error) {
	req := c.c.NewRequest(c.name, "Category.FindCatehoryByLevel", in)
...
type CategoryHandler interface {
	...
	FindCatehoryByLevel(context.Context, *FindByLevelRequest, *FindAllResponse) error
...
func RegisterCategoryHandler(s server.Server, hdlr CategoryHandler, opts ...server.HandlerOption) error {
	type category interface {
		...
		FindCatehoryByLevel(ctx context.Context, in *FindByLevelRequest, out *FindAllResponse) error
...
func (h *categoryHandler) FindCatehoryByLevel(ctx context.Context, in *FindByLevelRequest, out *FindAllResponse) error {
	return h.CategoryHandler.FindCatehoryByLevel(ctx, in, out)
}
